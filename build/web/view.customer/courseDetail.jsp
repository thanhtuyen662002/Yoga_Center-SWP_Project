                        ...
                        <div class="aa">
                            <div class="price-detail-box">
                                <div class="price-detail-head">
                                    ...
                                    <c:set var="d" value="${d.discount/100}"/>
                                ...
                                <div class="price-detail-bottom">
                                    <ul>
                                        ...
                                        <li>
                                            ...
                                            <div class="price-detail-right-price"><fmt:formatNumber type="currency"  value="${c.price - (c.price * d)}" currencyCode="VND"/></div>
                                        </li>
                                        <li>
                                            <div class="price-detail-right-text">Chí phí / ngày</div>
                                            <div class="price-detail-right-price"><fmt:formatNumber type="currency"  value="${(c.price - (c.price * d))/30}" currencyCode="VND"/></div>
                                        </li>
