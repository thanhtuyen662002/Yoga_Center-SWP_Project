...
<html lang="vi">
    <head>
        ...
        <link
            ...
            />
        <link rel="stylesheet" href="./css/editProfile_1.css" />
        ...
        <div class="container bootstrap snippets bootdey">
            ...
            <div class="row">
                ...
                <div class="col-md-3">
                    <div class="text-center">
                        <img
                            ...
                            alt="avatar"
                            />
                        <h3 style="font-weight: 700;">${account.name}</h3>
                    </div>
                </div>
                ...
                <div class="col-md-9 personal-info">
                    ...
                    <form id="frm-edit" method="post" action="editprofilecus" class="form-horizontal" role="form">
