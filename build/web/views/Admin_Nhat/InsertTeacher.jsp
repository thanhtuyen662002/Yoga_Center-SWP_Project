...
<html lang="en">
    ...
    <body>
        ...
        <div id="content">
            ...
            <div class="m-3 parent pl-3" style="height: 40%;background-color: rgba(0, 0, 0, 0.1);border-radius: 10px;padding-top: 2%">
                <div class="justify-content-center d-flex">
                    <c:if test="${fn:length(msgError) >= 1}">
                        <span id="error-fullname" class="error-message" style="color: red;">${msgError}</span>
                    </c:if>
                </div> 
                <form id="frm-submit" action="insertTeacher" method="post" style="padding-right: 30%">
                    <div class="mb-3 row">  
