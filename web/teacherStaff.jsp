                        ...
                        <c:forEach items="${list}" var="x">
                            <tr>
                                ...
                                <c:if test="${x.status == 'true'}">
                                    <td><a href="setStatus?status=true&phone=${x.phone}" style="font-weight: 700; color: green">ACTIVE</a></td>
                                </c:if>
                                <c:if test="${x.status == 'false'}">
                                    <td><a href="setStatus?status=false&phone=${x.phone}" style="font-weight: 700; color: red">DEACTIVE</a></td>
                                </c:if>
                                    <td><a href="updateTeacher?phone=${x.phone}" style="font-weight: 700">VIEW</a></td>
                            </tr>
                        </c:forEach>
                </table>
