...
//        processRequest(request, response);
            String nstphone = request.getParameter("stPhone");
            String ntitle = request.getParameter("title");
            String ndate = request.getParameter("postDate");
            ...
            dao.insertNews(nstphone, ntitle, ndate, nimage, ncontent, ncategoryID);
