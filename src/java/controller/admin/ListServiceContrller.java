 ...
 * @author nhath
 */
public class ListServiceContrller extends HttpServlet {
    String gender = "All";
    String status = "All";
    String textSearch = "";
    int page;
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet ListServiceContrller</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet ListServiceContrller at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        ArrayList<UserDTO> listService = uDao.
                getAllService((page - 1) * recordsPerPage, recordsPerPage,
                        gender, status, textSearch);
        int noOfRecords = uDao.getTotalRecordsSV(gender, status, textSearch);
        ...
        request.getRequestDispatcher("views/Admin_Nhat/ListService.jsp").forward(request, response);
    }
////
//
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        switch (action) {
            case "search":
                ...
                break;
            case "create":
                response.sendRedirect("insertService");
                break;
            case "deactive":
