 ...
 * @author HOANG ANH
 */
@WebServlet(name = "EditProfileCustomerServlet", urlPatterns = {"/editprofilecus"})
public class EditProfileCustomerServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet EditProfileCustomerServlet</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet EditProfileCustomerServlet at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
...
//        processRequest(request, response);
        ...
        request.getRequestDispatcher("view.customer/editprofilecus.jsp").forward(request, response);
    }
